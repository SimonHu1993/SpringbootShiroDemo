...
import com.simonhu.common.filter.KickoutSessionControlFilter;
import com.simonhu.modules.sys.shiro.UserRealm;
...
public class ShiroConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "simonhu", name = "cluster", havingValue = "false")
    public DefaultWebSessionManager sessionManager(@Value("${simonhu.globalSessionTimeout:3600}") long globalSessionTimeout) {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "simonhu", name = "cluster", havingValue = "true")
